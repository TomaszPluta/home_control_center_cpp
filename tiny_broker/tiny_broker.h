...
typedef int (*broker_net_conn)(void *cntx, sockaddr_t * rx_sockaddr);
typedef int (*broker_net_send)(void *cntx, sockaddr_t * rx_sockaddr, const uint8_t* buf, uint16_t buf_len);
typedef int (*broker_net_rec)(void *cntx, sockaddr_t * rx_sockaddr, uint8_t* buf, uint16_t buf_len);
typedef int (*broker_net_discon)(void *context, sockaddr_t * rx_sockaddr);
