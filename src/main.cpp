...
//
	 ...
	 TM_ILI9341_Puts(40,10, "Main screen", &TM_Font_16x26, ILI9341_COLOR_WHITE);

	 TM_ILI9341_DrawFilledRectangle(0, 196,ILI9341_WIDTH,231, ILI9341_COLOR_WHITE);
	 TM_ILI9341_Puts_background(10,200, "Temp", &TM_Font_16x26, ILI9341_COLOR_BLACK, ILI9341_COLOR_WHITE);

	 TM_ILI9341_Puts_background(10,230, "Press", &TM_Font_16x26, ILI9341_COLOR_BLACK, ILI9341_COLOR_WHITE);

	 TM_ILI9341_DrawRectangle(0, 256,ILI9341_WIDTH,281, ILI9341_COLOR_WHITE);
	 TM_ILI9341_Puts(10,260, "Humid", &TM_Font_16x26, ILI9341_COLOR_WHITE);

	 TM_ILI9341_DrawRectangle(0, 286,ILI9341_WIDTH,311, ILI9341_COLOR_WHITE);
	 TM_ILI9341_Puts(10,290, "Light", &TM_Font_16x26, ILI9341_COLOR_WHITE);




	 TM_ILI9341_Puts_background(180,200, "22", &TM_Font_16x26, ILI9341_COLOR_BLACK, ILI9341_COLOR_WHITE);
	 TM_ILI9341_Puts_background(180,230, "987", &TM_Font_16x26,  ILI9341_COLOR_BLACK, ILI9341_COLOR_WHITE);
	 TM_ILI9341_Puts(180,260, "48", &TM_Font_16x26, ILI9341_COLOR_WHITE);
	 TM_ILI9341_Puts(180,290, "73", &TM_Font_16x26, ILI9341_COLOR_WHITE);


best effect: redraw screen with dma
